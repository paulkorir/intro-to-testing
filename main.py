...
def solve(a, b, c):
    ...
    :param float b: coefficient of x^1
    :param float c: coefficient of x^0
    :return: solutions to the quadratic equation
    :rtype: tuple(float, float)
    :rtype: tuple(complex, complex)
    """
...
def main():
    try:
        ...
        print(f"usage: python main.py a b c", file=sys.stderr)
        return os.EX_USAGE
    except ValueError:
